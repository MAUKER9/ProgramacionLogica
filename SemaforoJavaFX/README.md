...
- **Juego**: pulsa el botón "¡Luz verde!" únicamente cuando el semáforo esté en verde. Cada acierto suma puntaje según tu velocidad de reacción y cada error incrementa el contador de fallos.
